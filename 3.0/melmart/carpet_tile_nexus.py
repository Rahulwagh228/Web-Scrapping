...
cookies = {
    ...
    '__stripe_sid': 'a6ba5aea-fd2a-4f12-aeb6-bb183a371843e5e9ad',
    '_gat': '1',
    'sbjs_session': 'pgs%3D73%7C%7C%7Ccpg%3Dhttps%3A%2F%2Fmelmart.com%2Fbrands%2Fnexus%2F',
    '_ga_BPEVSBVR9J': 'GS1.2.1715176611.5.1.1715180994.0.0.0',
}
...
def get_product_data(url):
    ...
    for i in ['Floor Type', 'Installation', 'Radiant Heat', 'Warranty', 'Backing', 'Fibre, Pile Weight, Gauge', 'Packaging', 'Sustainability', 'Flammability and Static', 'Size', 'Installation Methods']:
        if i not in specs:
            specs[i] = ''
    ...
    d['Fibre, Pile Weight, Gauge'] = specs['Fibre, Pile Weight, Gauge']
    d['Packaging'] = specs['Packaging']
    d['Sustainability'] = specs['Sustainability']
    d['Flammability and Static'] = specs['Flammability and Static']
    d['Size'] = specs['Size']
    d['Installation Methods'] = specs['Installation Methods']
...
collections = {
     '0':'https://melmart.com/brands/nexus/',
     '1':'https://melmart.com/brands/nexus/page/2/',
     '2':'https://melmart.com/brands/nexus/page/3/'
