...
cookies = {
    ...
    'sbjs_session': 'pgs%3D47%7C%7C%7Ccpg%3Dhttps%3A%2F%2Fmelmart.com%2Fproduct%2Fmemoirs-dickens-melm1wp016%2F',
    '_gat': '1',
    '_ga_BPEVSBVR9J': 'GS1.2.1715176611.5.1.1715177497.0.0.0',
}
...
def get_product_data(url):
    ...
    for i in  ['Bevel', 'Collection', 'Edge', 'Floor Type', 'Installation', 'Length', 'Plank Width', 'Radiant Heat', 'Thickness', 'Wear Layer', 'Packaging']:
         if i not in specs:
              specs[i] = ' '
...
collections = {
     '0':'https://melmart.com/brands/memoirs/',
     '1':'https://melmart.com/brands/memoirs/page/2/'
    #  '2':'',
