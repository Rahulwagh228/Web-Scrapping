...
def extract_HERRINGBONE_CUSTOM():
    ...
    headers = {
        ...
        'priority': 'u=1, i',
        'referer': 'https://www.provenzafloors.com/hardwood/detail?sku=HR001&color=HR001&collection=Herringbone%20Custom',
