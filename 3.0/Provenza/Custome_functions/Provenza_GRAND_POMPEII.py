...
def extract_GRAND_POMPEII():
    ...
    headers = {
        ...
        'priority': 'u=1, i',
        'referer': 'https://www.provenzafloors.com/hardwood/detail?sku=PRO731&color=Apollo&collection=Grand%20Pompeii',
