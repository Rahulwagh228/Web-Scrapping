...
def extract_AFRICAN_PLAINS():
    ...
    headers = {
        ...
        'priority': 'u=1, i',
        'referer': 'https://www.provenzafloors.com/hardwood/detail?sku=PRO590&color=Congo&collection=African%20Plains',
