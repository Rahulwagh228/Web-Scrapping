...
def extract_LIGHTHOUSE_COVE():
    ...
    headers = {
        ...
        'priority': 'u=1, i',
        'referer': 'https://www.provenzafloors.com/hardwood/detail?sku=PRO9000&color=Ivory%20White%20Weathered&collection=Lighthouse%20Cove',
