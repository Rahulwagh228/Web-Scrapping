...
def extract_STUDIO_MODERNO():
    ...
    headers = {
        ...
        'priority': 'u=1, i',
        'referer': 'https://www.provenzafloors.com/hardwood/detail?sku=PRO1600&color=Fellini&collection=Studio%20Moderno',
