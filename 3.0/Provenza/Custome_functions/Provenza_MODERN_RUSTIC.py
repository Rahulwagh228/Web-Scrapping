...
def extract_MODERN_RUSTIC():
    ...
    headers = {
        ...
        'priority': 'u=1, i',
        'referer': 'https://www.provenzafloors.com/hardwood/detail?sku=PRO1402&color=Mystic%20Grey&collection=Modern%20Rustic',
