...
def extract_NEW_YORK_LOFT():
    ...
    headers = {
        ...
        'priority': 'u=1, i',
        'referer': 'https://www.provenzafloors.com/hardwood/detail?sku=PRO2700&color=Big%20Apple&collection=New%20York%20Loft',
