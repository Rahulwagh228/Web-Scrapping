...
def extract_HERRINGBONE_RESERVE():
    ...
    headers = {
        ...
        'priority': 'u=1, i',
        'referer': 'https://www.provenzafloors.com/hardwood/detail?sku=HER1000&color=Autumn%20Wheat&collection=Herringbone%20Reserve',
    ...
    json_data = {
        ...
        'tileType': 'Hardwood',
        'manufacturer': '',
        'collection': 'Herringbone Reserve',
    }
