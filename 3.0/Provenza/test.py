...
def extract_AFFINITY():
    ...
    headers = {
        ...
        'priority': 'u=1, i',
        'referer': 'https://www.provenzafloors.com/hardwood/detail?sku=PRO2318&color=Contour&collection=Affinity',
    ...
    url = 'https://www.provenzafloors.com/api/ProductApi/getDetailInfoUsingCollection'
    ...
    if response.status_code == 200:
        ...
        for  data in data:
                ...
                d['residentialWarranty'] = residentialWarranty
                d['coverage'] = coverage
